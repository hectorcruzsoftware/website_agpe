							...
							<div class="row">
								...
								<div class="col-sm-12 col-lg-6">
									<div class="input-check">
										<input type="checkbox" id="chkTerminos" name="chkTerminos" value="1" <?= WP_DEBUG ? 'checked' : ''; ?>> <label> He leído el <a href="#" data-toggle="modal" data-target="#ModalAviso">Aviso de privacidad</a> y deseo recibir información.</label><br>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="input">
